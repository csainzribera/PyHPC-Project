...
if __name__ == '__main__':
    ...
    jacobi_numba(u_warm, mask_warm, 1, ABS_TOL)          # The number of iterations is irrelevant we just one to compile it
    ...
    print(f"\nTotal computation time for {N} floors: {end_time:.4f} segundos")
    print(f"Average computation per floor: {end_time/N:.4f} segundos")